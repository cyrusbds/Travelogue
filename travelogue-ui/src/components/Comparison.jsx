...
const FEATURES = [
  {
    ...
    rows: [
      {
        label: "Group itinerary planning",
        travelogue: "yes",
        gdocs: "partial:Manual",
        whatsapp: "no",
      },
      {
        label: "Account required to join",
        travelogue: "yes",
        gdocs: "yes",
        whatsapp: "yes",
      },
...
function Cell({ value }) {
  ...
  if (value?.startsWith("partial:"))
    return <span className="comp-partial">{value.slice(8)}</span>;
  return null;
}
      ...
      <div className="container">
        <div className="comparison-header">
          ...
          <h2 className="section-title">
            Why Travelogue beats the alternatives.
          </h2>
                ...
                <>
                  ...
                  {rows.map((row) => (
                    <tr key={row.label}>
                      <td>{row.label}</td>
                      <td>
                        <Cell value={row.travelogue} />
                      </td>
                      <td>
                        <Cell value={row.gdocs} />
                      </td>
                      <td>
