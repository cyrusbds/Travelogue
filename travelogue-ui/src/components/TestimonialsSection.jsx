const TESTIMONIALS = [
  ...
  },
  {
    ...
    name: "Sara Chen",
    role: "Singapore · Team Offsite Organizer",
    av: "S",
    color: "#C8A03A",
    featured: false,
  },
  {
    ...
    name: "Lena Volkova",
    role: "Moscow, Russia · Bali girls trip",
    av: "L",
    color: "#9B59B6",
    featured: false,
  },
      ...
      <section className="testimonials" id="testimonials">
        <div className="testimonials-header">
          ...
          <p className="section-sub">
            Real feedback from real trips. No embellishment, just results.
          </p>
        </div>
        ...
        <div className="testi-grid">
          {TESTIMONIALS.map((t) => (
            <div
              className={`testi-card reveal${t.featured ? " featured" : ""}`}
              key={t.name}
            >
