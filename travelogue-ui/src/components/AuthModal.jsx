        ...
        {password.length > 0 && (
          <>
            ...
            <div className="pw-requirements">
              <div className={`pw-req${strength.hasLen ? " met" : ""}`}>
                <span className="req-dot">●</span> At least 8 characters
              </div>
              <div className={`pw-req${strength.hasUpper ? " met" : ""}`}>
                <span className="req-dot">●</span> One uppercase letter
              </div>
              <div className={`pw-req${strength.hasNum ? " met" : ""}`}>
                <span className="req-dot">●</span> One number
              </div>
            </div>
          </>
        )}
  ...
  return (
    <div>
      ...
      <p className="forgot-sub">
        Enter your email and we'll send you a reset link within a minute.
      </p>
        ...
        <div className="auth-panel-left">
          ...
          <div className="auth-testimonial">
            <div className="auth-testi-text">
              "Travelogue made planning our 10-person Morocco trip genuinely
              fun. Everyone was involved from day one."
            </div>
          ...
          <div className="auth-left-trust">
            <div className="auth-trust-item">
              <GlobeIcon /> 90+ countries
            </div>
            <div className="auth-trust-item">
              <UsersIcon /> 48,000+ travelers
            </div>
            <div className="auth-trust-item">
              <StarIcon /> 4.9 / 5 rating
            </div>
          </div>
        </div>
          ...
          {success ? (
            ...
            <>
              ...
              {tab === "login" ? (
                ...
                <SignupForm onSuccess={handleSuccess} onSwitch={setTab} />
              )}
            </>
          )}
        </div>
