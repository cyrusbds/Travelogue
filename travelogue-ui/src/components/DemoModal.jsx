        ...
        {step === 1 ? (
          <>
            ...
            <div className="demo-panel-left">
              ...
              <div className="demo-quote">
                <div className="demo-quote-text">
                  "Travelogue handles all our student trip coordination. It
                  replaced 3 different tools we were using."
                </div>
            ...
            <div className="demo-panel-right">
              ...
              <p className="demo-sub">
                Tell us a bit about your organisation and we'll reach out within
                1 business day.
              </p>
              ...
              <form className="auth-form" onSubmit={handleSubmit} noValidate>
                ...
                <div className="field-group">
                  ...
                  {errors.org && (
                    <div className="field-error">{errors.org}</div>
                  )}
                </div>
                ...
                <div className="name-row">
                  <div className="field-group">
                    ...
                    {errors.useCase && (
                      <div className="field-error">{errors.useCase}</div>
                    )}
                  </div>
                  <div className="field-group">
                ...
                <p className="co-cancel-note">
                  We typically respond within 1 business day. No commitment
                  required.
                </p>
              </form>
            </div>
          ...
          <div className="demo-success">
            ...
            <div className="demo-success-sub">
              Thanks, <strong>{form.name.split(" ")[0]}</strong>. We'll reach
              out to <strong>{form.email}</strong> within 1 business day to
              schedule your demo.
            </div>
            <button
              className="auth-submit-btn"
