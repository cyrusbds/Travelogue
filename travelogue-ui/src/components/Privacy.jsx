        ...
        <div className="security-inner">
          ...
          <div className="reveal">
            ...
            <p className="section-sub">
              We take the privacy of your travel plans seriously. Travelogue is
              built on a foundation of security and transparency — no selling
              your data, no ads, no nonsense.
            </p>
