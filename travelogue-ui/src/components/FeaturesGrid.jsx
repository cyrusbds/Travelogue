  ...
  },
  {
    icon: (
      <svg
        ...
        strokeLinejoin="round"
      >
        <polyline points="22 2 13.5 20.5 11 13 4 10.5 22 2" />
        <line x1="13.5" y1="13" x2="11" y2="13" />
      </svg>
    ),
    color: "terra",
      ...
      <section className="features" id="features">
        <div className="features-header">
          ...
          <h2 className="section-title">
            Everything your group needs in one notebook.
          </h2>
          <p className="section-sub">
            Built for how real friend groups actually travel — collaboratively,
