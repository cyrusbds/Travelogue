...
const USE_CASES = [
  {
    ...
    description:
      "End the group chat chaos. Everyone sees the plan, votes on activities, and knows who owes what — so you arrive as a team, not a headache.",
  ...
  },
  {
    ...
    description:
      "Coordinate guests flying in from different cities. One shared notebook for airport logistics, hotel blocks, activities, and the big-day schedule.",
  ...
  },
  {
    ...
    description:
      "Deliver a premium client experience. Use Travelogue's Institutional plan to provide white-labeled group itineraries under your own brand.",
