      ...
      <div className="container">
        ...
        <div className="steps reveal">
          <div className="step">
            ...
            <p>
              Give your trip a name, set your dates, and your digital travel
              notebook is instantly ready. No sign-up required.
            </p>
          </div>
          <div className="step">
          ...
          <div className="step">
            ...
            <p>
              Everyone edits, votes, and contributes in real time. Watch your
              shared itinerary come to life as a team.
            </p>
          </div>
        </div>
      </div>
