        ...
        <div className="about-inner">
          ...
          <div>
            ...
            <h2 className="section-title">
              Your trip, shared equally — start to finish.
            </h2>
            <p className="section-sub">
              Travelogue is a shared digital travel notebook where every member
              of your group has full, equal access. No more "ask the planner" —
              everyone sees everything, edits together, and owns the journey.
            </p>
            <div className="about-stats">
              <div className="stat-card">
                <div className="stat-num">Free</div>
                <div className="stat-desc">
                  Plan to start with no card needed
                </div>
              </div>
              <div className="stat-card">
          ...
          <div className="about-features-list reveal">
            <div className="about-feat">
              ...
              <div className="about-feat-text">
                ...
                <p>
                  One living document your whole group can see, edit, and build
                  in real time.
                </p>
              </div>
            </div>
            ...
            <div className="about-feat">
              ...
              <div className="about-feat-text">
                ...
                <p>
                  No admin gate-keeping. Every member can add, update, and
                  contribute equally.
                </p>
              </div>
            </div>
            ...
            <div className="about-feat">
              ...
              <div className="about-feat-text">
                ...
                <p>
                  Designed from day one for the messy, beautiful reality of
