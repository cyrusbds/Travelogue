...
export default function CheckoutModal({ open, annual, onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (card.replace(/\s/g, "").length !== 16)
      errs.card = "Please enter a 16-digit card number.";
        ...
        {step === 1 ? (
          <>
            <div className="co-header">
              ...
              <p className="co-sub">
                14 days free, then <strong>{price} AED/month</strong>. Cancel
                any time before trial ends — no charge.
              </p>
            </div>
            ...
            <form className="auth-form" onSubmit={handleSubmit} noValidate>
              ...
              <div className="field-group">
                ...
                <div className="field-wrap card-number-wrap">
                  ...
                  <div className="card-brands">
                    <svg width="28" height="18" viewBox="0 0 38 24" fill="none">
                      ...
                      <path
                        d="M14.5 16.5h-3l1.88-9h3L14.5 16.5zm6.75-8.7c-.6-.23-1.53-.47-2.7-.47-2.98 0-5.07 1.47-5.08 3.58-.02 1.55 1.49 2.42 2.63 2.93 1.17.53 1.56.86 1.55 1.33-.01.72-.93 1.05-1.79 1.05-1.2 0-1.83-.16-2.81-.56l-.38-.17-.42 2.42c.7.3 1.99.56 3.33.57 3.15 0 5.19-1.45 5.22-3.69.01-1.23-.79-2.17-2.52-2.94-1.05-.5-1.69-.84-1.68-1.34 0-.45.54-.93 1.71-.93.98-.02 1.69.2 2.24.42l.27.12.41-2.33z"
                        fill="white"
                      />
                    </svg>
                    <svg width="28" height="18" viewBox="0 0 38 24" fill="none">
                      ...
                      <path
                        d="M19 16.5c1.5-1.2 2.5-3 2.5-4.5S20.5 8.7 19 7.5C17.5 8.7 16.5 10.5 16.5 12s1 3.3 2.5 4.5z"
                        fill="#FF5F00"
                      />
                    </svg>
                  </div>
                ...
                {errors.card && (
                  <div className="field-error">{errors.card}</div>
                )}
              </div>
              ...
              <p className="co-cancel-note">
                Cancel before day 14 and you won't be charged. No cancellation
                fees.
              </p>
            </form>
          </>
