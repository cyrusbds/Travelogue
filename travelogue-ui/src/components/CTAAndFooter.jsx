      ...
      <section className="cta-section" id="cta">
        <div className="cta-inner">
          <h2>
            ...
            <br />
            <em>before you leave.</em>
          </h2>
          <p>
            Create your free account, start a notebook, and invite your group in
            seconds.
          </p>
          <button
...
const SOCIALS = [
  {
    icon: <InstagramIcon />,
    href: "https://www.instagram.com/the_travelogue.official?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==",
    label: "Instagram",
  },
...
const FOOTER_COLS = [
  ...
  {
    title: "Company",
    links: ["Our Story", "Blog", "Careers", "Press Kit", "Partners", "Contact"],
  },
  {
    title: "Support",
    links: [
        ...
        <div className="footer-inner">
          <div className="footer-top">
            <div className="footer-brand">
              ...
              <p>
                A shared travel notebook for groups. No accounts. No chaos. Just
                your next adventure, planned together.
              </p>
          ...
          <div className="footer-bottom">
            <span>
              © 2026 Travelogue. Made with ❤ for travelers, by travelers. ·
              Sharjah, UAE 🇦🇪
            </span>
