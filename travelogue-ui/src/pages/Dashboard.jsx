    ...
    <div className="cal-wrap" ref={ref}>
      ...
      >
        ...
        <span className="cal-val">
          {displayVal || <span className="cal-placeholder">Select date</span>}
        </span>
        <span
    ...
    >
      <div className="db-modal" style={{ maxWidth: 380 }}>
        <div className="db-modal-top">
          ...
          <button className="db-modal-x" onClick={onClose}>
            {Icons.close}
          </button>
        </div>
        <div className="db-modal-body">
          ...
          >
            ...
            <strong style={{ color: "var(--warm-dark)" }}>{trip.name}</strong>?
            All activities, expenses, votes, and messages will be permanently
            removed.
          </p>
    ...
    >
      <div className="db-modal" style={{ maxWidth: 440 }}>
        ...
        <div className="db-modal-body">
          ...
          >
            The <strong style={{ color: "var(--warm-dark)" }}>Free plan</strong>{" "}
            includes{" "}
            <strong style={{ color: "var(--warm-dark)" }}>1 active trip</strong>
            . Upgrade to{" "}
            <strong style={{ color: "var(--terracotta)" }}>Premium</strong> to
            unlock everything.
          </p>
          <div
            style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <button className="db-btn-ghost" onClick={onClose}>
              Maybe later
            </button>
          </div>
          <p
...
function BillingSheet({ onClose, user, onUpgrade }) {
  ...
  const statusConfig = {
    premium: {
      color: "#5C7A5E",
      bg: "linear-gradient(135deg,#D4E8D4,#EDE0C4)",
      label: "Premium · Active",
      icon: Icons.shield,
    },
    trial: {
      color: "#C8623A",
      bg: "linear-gradient(135deg,#F5D4C4,#EDE0C4)",
      label: `Trial · ${billing.daysLeft} day${billing.daysLeft !== 1 ? "s" : ""} left`,
      icon: Icons.zap,
    },
    expired: {
      color: "#C44",
      bg: "linear-gradient(135deg,#fde8e8,#fdf0e0)",
      label: "Trial Expired",
    ...
    <>
      ...
      <div className="db-sheet">
        ...
        <div className="db-sh-head">
          ...
          <button className="db-sh-close" onClick={onClose}>
            {Icons.close}
          </button>
        </div>
        <div className="db-sh-body">
          ...
          >
              ...
              <>
                ...
                >
                  <div
                    style={{
                      height: "100%",
                      width: `${Math.max(5, ((14 - billing.daysLeft) / 14) * 100)}%`,
                      background: "#C8623A",
                      borderRadius: 99,
                ...
                >
                  <span>Day 1</span>
                  <span>
                    {billing.daysLeft} day{billing.daysLeft !== 1 ? "s" : ""}{" "}
                    remaining
                  </span>
                  <span>Day 14</span>
                </div>
            ...
            {billing.type === "expired" && (
              <div style={{ fontSize: "0.78rem", color: "#C44", marginTop: 4 }}>
                Your trial has ended. Upgrade to regain full access.
              </div>
            )}
            {billing.type === "cancelled" && (
              <div
                style={{
                  fontSize: "0.78rem",
                  color: "var(--text-light)",
              ...
              >
                Your subscription was cancelled. Reactivate any time.
              </div>
            )}
            {billing.type === "free" && (
              <div
              ...
              >
                1 active trip included. Upgrade for unlimited trips.
              </div>
            )}
          </div>
          ...
          {billing.type !== "premium" && (
            ...
            >
              ...
              >
                {billing.type === "expired" || billing.type === "cancelled"
                  ? "Reactivate"
                  : "Premium Plan"}
              </div>
              <div
      ...
      <div className="db-sheet">
        ...
        <div className="db-sh-body">
          <div style={{ marginBottom: 18 }}>
            ...
            />
            <label className="db-fl" style={{ marginTop: 10 }}>
              Last name
            </label>
            <input
              className="db-si"
          ...
          {[
            {
              key: "activity",
              label: "Trip activity",
              sub: "Edits and updates from group members",
            },
            {
              key: "votes",
              label: "New votes & invites",
              sub: "Polls and trip invitations",
            },
            {
              key: "settlement",
              label: "Settlement reminders",
              sub: "Nudges to settle up after trips",
            },
            {
              key: "marketing",
              label: "Marketing emails",
              sub: "Tips and travel inspiration",
            },
          ].map((n) => (
            <div key={n.key} className="db-sr">
              ...
              <button
                className={`db-tog${notifs[n.key] ? " on" : ""}`}
            ...
            <div className="db-up-card">
              <div className="db-up-t">
                <div className="db-up-title">
                  ...
                  >
                    {Icons.sparkle} Upgrade to Premium
                  </span>
                </div>
                <div className="db-up-sub">
                  Unlimited trips, budget splitter &amp; more
                </div>
              </div>
              <button className="db-up-btn">14.99 AED/mo</button>
            </div>
          )}
          <button className="db-save-btn" onClick={onClose}>
            Save Changes
          </button>
...
const TRIP_COLORS = {
  ...
  Upcoming: {
    border: "#3A7CA5",
    bg: "linear-gradient(135deg,#C4DCF0,#D4E8D4)",
    statusClass: "s-up",
  },
  ...
  return (
    ...
    >
      ...
      <div className="db-trip-right">
        <span className={`db-status ${colors.statusClass}`}>
    ...
    <div className="db-root">
            ...
            {ddOpen && (
              <div className="db-dropdown">
                <div className="db-dd-head">
                  ...
                  <div className="db-dd-plan">
                    {user?.email} · {planLabel}
                  </div>
                </div>

                {billingStatus.type === "trial" &&
                  billingStatus.daysLeft <= 3 && (
                    <div
                      style={{
                        margin: "6px 12px 2px",
                        padding: "8px 10px",
                    ...
                    >
                      {Icons.alertCircle} Trial ends in {billingStatus.daysLeft}{" "}
                      day{billingStatus.daysLeft !== 1 ? "s" : ""}
                    </div>
                  )}
      ...
      <div className="db-container">
        ...
        <div className="db-greeting">
          ...
          {trips.length > 0 ? (
            <p>
              {trips.length} trip{trips.length > 1 ? "s" : ""} planned · Let's
              keep exploring!
            </p>
          ) : (
            <p>
        ...
        {billingStatus.type === "trial" && billingStatus.daysLeft <= 3 && (
          <div
            style={{
              ...
              justifyContent: "space-between",
              gap: 12,
              background: "linear-gradient(135deg,#FDF0E8,#FBF6EC)",
              border: "1.5px solid rgba(200,98,58,0.25)",
              borderRadius: 14,
              padding: "14px 20px",
              marginBottom: 24,
              flexWrap: "wrap",
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <div style={{ color: "#C8623A", display: "flex" }}>
                {Icons.alertCircle}
              </div>
              <div>
                <div
                ...
                >
                  Your trial ends in {billingStatus.daysLeft} day
                  {billingStatus.daysLeft !== 1 ? "s" : ""}
                </div>
                <div
                  style={{
                    fontSize: "0.76rem",
                ...
                >
                  You'll be charged 14.99 AED/mo automatically — or cancel
                  before it ends
                </div>
              </div>
            </div>
        ...
        {billingStatus.type === "expired" && (
          <div
            style={{
              ...
              justifyContent: "space-between",
              gap: 12,
              background: "linear-gradient(135deg,#fde8e8,#fdf0e0)",
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <div style={{ color: "#C44", display: "flex" }}>
                {Icons.alertCircle}
              </div>
              <div>
                <div
                ...
                >
                  Upgrade to Premium to continue planning unlimited trips
                </div>
              </div>
            </div>
            <button
        ...
        {billingStatus.type === "free" && trips.length >= 1 && (
          <div
            style={{
              ...
              gap: 12,
              background: "linear-gradient(135deg,#FDF0E8,#FBF6EC)",
              border: "1.5px solid rgba(200,98,58,0.2)",
              borderRadius: 14,
              padding: "14px 20px",
              marginBottom: 24,
              flexWrap: "wrap",
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <div>
                ...
                >
                  Free plan: 1 trip limit reached
                </div>
                <div
                  style={{
                    fontSize: "0.76rem",
                ...
                >
                  Upgrade to Premium for unlimited trips and all features
                </div>
              </div>
            </div>
            <button
            ...
            >
              <span
                style={{ display: "inline-flex", alignItems: "center", gap: 6 }}
              >
                {Icons.sparkle} Upgrade — 14.99 AED/mo
              </span>
            </button>
          </div>
        )}
        ...
        <div className="db-section">
          <div className="db-section-label">
            Pending Invites
            {invites.length > 0 && (
              <span className="db-inv-count">{invites.length}</span>
            )}
          </div>
          {invites.length === 0 && (
            <div className="db-empty-banner">No invitations yet.</div>
          )}
          {invites.map((inv) => (
            <div key={inv.id} className="db-invite-banner">
              ...
              <div className="db-invite-text">
                ...
                <div className="db-invite-sub">
                  {inv.inviter} invited you · {inv.dates} · {inv.members}{" "}
                  members
                </div>
              </div>
          ...
          {!loading && trips.length === 0 && (
            <div className="db-empty-trips">
              ...
              <div className="db-empty-sub">
                Plan your first adventure and invite your group
              </div>
              <button
                className="db-btn-main"
                style={{ marginTop: 16 }}
                onClick={tryOpenNewTrip}
              >
                <span
                  style={{
                    display: "inline-flex",
